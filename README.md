...
```javascript
import iterCounter from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-counter@v0.2.1-esm/index.mjs';
```
...
[@stdlib/iter/length]: https://github.com/stdlib-js/iter-length/tree/esm
